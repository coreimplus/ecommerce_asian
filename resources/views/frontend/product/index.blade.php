                    ...
                    <form action="{{ route('products.index') }}" method="GET">
                        ...
                        @foreach($sizes as $key => $size)
                            <div
                                ...
                                <input name="size[]" type="checkbox" class="custom-control-input"
                                       value="{{ $size->id }}"
                                       @if(in_array($size->id, request()->has('size') ? request()->size : [])) checked
                                       @endif
                                       id="size-{{ $key }}" onchange="this.form.submit()">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="{{ $product->image_one }}" alt="">
