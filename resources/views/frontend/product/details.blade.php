        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <a class="breadcrumb-item text-dark" href="{{ route('products.index') }}">Shop</a>
                    ...
                    <div class="carousel-inner bg-light">
                        @if($product->image_one)
                            <div class="carousel-item active">
                                <img class="w-100 h-100" src="{{ $product->image_one }}" alt="Image">
                            </div>
                        @endif
                        @if($product->image_two)
                            <div class="carousel-item">
                                <img class="w-100 h-100" src="{{ $product->image_two }}" alt="Image">
                            </div>
                        @endif
                        @if($product->image_three)
                            <div class="carousel-item">
                                <img class="w-100 h-100" src="{{ $product->image_three }}" alt="Image">
                            </div>
                        @endif
                    </div>
                    ...
                    @foreach($relatedProducts as $relatedProduct)
                        <div class="product-item bg-light">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ $relatedProduct->image_one }}" alt="">
